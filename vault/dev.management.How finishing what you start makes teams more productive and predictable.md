...
[![The production process of a single burger.](/assets/finish-what-you-start/one-burger-flow.png)](https://lucasfcosta.com/assets/finish-what-you-start/one-burger-flow.png)

_The production process of a single burger._
...
[![Preparing burgers in series causes both their cycle-times to be the same.](/assets/finish-what-you-start/two-burger-flow-sequential.png)](https://lucasfcosta.com/assets/finish-what-you-start/two-burger-flow-sequential.png)

_Preparing burgers in series causes both their cycle-times to be the same._
...
[![Preparing burgers concurrently elongates the burgers' cycle times.](/assets/finish-what-you-start/two-burger-flow-concurrent.png)](https://lucasfcosta.com/assets/finish-what-you-start/two-burger-flow-concurrent.png)

_Preparing burgers concurrently elongates the burgers' cycle times._
...
[![The more burgers the cook prepares concurrently, the longer cycle times become.](/assets/finish-what-you-start/three-burger-flow-concurrent.png)](https://lucasfcosta.com/assets/finish-what-you-start/three-burger-flow-concurrent.png)

_The more burgers the cook prepares concurrently, the longer cycle times become._
...
[![Preparing three burgers in series ensures that all burgers' cycle times remain equal, and that the first two will be delivered earlier.](/assets/finish-what-you-start/three-burger-flow-serial.png)](https://lucasfcosta.com/assets/finish-what-you-start/three-burger-flow-serial.png)

_Preparing three burgers in series ensures that all burgers' cycle times remain equal, and that the first two will be delivered earlier._
...
[![Working on features concurrently causes features to take longer.](/assets/finish-what-you-start/features-concurrent.png)](https://lucasfcosta.com/assets/finish-what-you-start/features-concurrent.png)

_Working on features concurrently causes features to take longer._
...
[![Working on features in series shortens each feature's cycle time, and allows the first to be delivered earlier.](/assets/finish-what-you-start/features-in-series.png)](https://lucasfcosta.com/assets/finish-what-you-start/features-in-series.png)

_Working on features in series shortens each feature's cycle time, and allows the first to be delivered earlier._
...
This same effect happens when a critical bug appears. [As I’ve previously explained](https://lucasfcosta.com/2022/07/15/long-term-plans-dont-work.html), such urgent work stops you from finishing your current task, delays it, and causes all other tasks in progress to take longer _on average_.
...
Avg. Cycle Time\=Avg. Work In ProgressAvg. Throughput {Avg.\\ Cycle\\ Time} = \\cfrac{Avg.\\ Work\\ In\\ Progress}{Avg.\\ Throughput} Avg. Cycle Time\=Avg. ThroughputAvg. Work In Progress​
...
[![There's a cost for switching from working on a feature to working on another.](/assets/finish-what-you-start/features-concurrent-context-switch.png)](https://lucasfcosta.com/assets/finish-what-you-start/features-concurrent-context-switch.png)

_There's a cost for switching from working on a feature to working on another._
...
[![When it's costly to move items from one stage to the next, items batch-up.](/assets/finish-what-you-start/small-batches-vs-large-batches-patties.png)](https://lucasfcosta.com/assets/finish-what-you-start/small-batches-vs-large-batches-patties.png)

_When it's costly to move items from one stage to the next, items batch-up._
...
[![With large batches, there's more variability in cycle times.](/assets/finish-what-you-start/cfd-large-batches.png)](https://lucasfcosta.com/assets/finish-what-you-start/cfd-large-batches.png)

_With large batches, there's more variability in cycle times._
...
[![Smaller batches decrease cycle time variability.](/assets/finish-what-you-start/cfd-small-batches.png)](https://lucasfcosta.com/assets/finish-what-you-start/cfd-small-batches.png)

_Smaller batches decrease cycle time variability._
...
[![If batch sizes also vary over time, distinct batches of customers see different variations of cycle time.](/assets/finish-what-you-start/cfd-different-batch-sizes.png)](https://lucasfcosta.com/assets/finish-what-you-start/cfd-different-batch-sizes.png)

_If batch sizes also vary over time, distinct batches of customers see different variations of cycle time._
...
If we go ahead and [use a Monte Carlo algorithm to simulate how many tasks this team can deliver](https://lucasfcosta.com/2021/09/20/monte-carlo-forecasts.html) in 30 days, we’ll obtain the following histogram.

[![Teams that deliver many tasks at once are less predictable because there's a wider range of possible outcomes when simulating their performance.](/assets/finish-what-you-start/histogram-concurrent-team.png)](https://lucasfcosta.com/assets/finish-what-you-start/histogram-concurrent-team.png)

_Teams that deliver many tasks at once are less predictable because there's a wider range of possible outcomes when simulating their performance._
...
[![Teams which consistently deliver a small number of tasks are more preditable because there's a smaller range of possible outcomes when simulating their performance.](/assets/finish-what-you-start/histogram-serial-team.png)](https://lucasfcosta.com/assets/finish-what-you-start/histogram-serial-team.png)
...
[![A team which always delivers the same number of tasks each day will yield a "deterministic" forecast (days times throughput).](/assets/finish-what-you-start/histogram-uniform-team.png)](https://lucasfcosta.com/assets/finish-what-you-start/histogram-uniform-team.png)

_A team which always delivers the same number of tasks each day will yield a "deterministic" forecast (days \* throughput)._
