...
-> 휴식도 마찬가지. 필요 없을 것 같아 강행한 결과 전체 비율로 손해를 보는 경우가 적다해도 그 조금의 손해조차 만들 필요는 없다.
AWS 권한 설정이 바로바로 적용이 안되서 헤매다가 결국 스트레스 많이 누적됨. 아오.

### Seoul in traces - [urban sketch](https://urbansketchers.org/what-is-urban-sketch/)
