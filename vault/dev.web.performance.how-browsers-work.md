---
id: fe433gfn6erguk7r9fxpgfv
title: "Populating the page: how browsers work"
desc: ""
updated: 1698829609051
created: 1698829545304
---
...
[Mobile requests go first to the cell tower, then to a central phone company computer before being sent to the internet](/en-US/docs/Web/Performance/How_browsers_work/latency.jpg)
...
[The DNS lookup, the TCP handshake, and 5 steps of the TLS handshake including clienthello, serverhello and certificate, clientkey and finished for both server and client.](/en-US/docs/Web/Performance/How_browsers_work/ssl.jpg)
...
[The DOM tree for our sample code, showing all the nodes, including text nodes.](/en-US/docs/Web/Performance/How_browsers_work/dom.gif)
...
[The main thread is occupied by the downloading, parsing and execution of a JavaScript file - over a fast connection](/en-US/docs/Web/Performance/How_browsers_work/visa_network.png)
